...
public class ClienteConstantes {
	...
	public static final String REQUIRED_DIRECCION = "El campo direccion es requerido";
	public static final String SUCCESS_MESSAGE = "Consulta exitosa";
	public static final String SUCCESS_LOG = "Operacion exitosa";
	public static final String CREATED_MSG = "El Cliente fue creado con exito";
	public static final String UPDATED_MSG = "El Cliente fue actualizado con exito";
	public static final String DELETED_MSG = "El Cliente fue eliminado con exito";
